            ...
            <el-tab-pane label="基础信息" name="base">
                <div @keyup.13="handleUpdateInfo">
                    ...
                    <el-form-item label="手机号" prop="phone">
                        <el-input v-model="userInfo.phone" auto-complete="off" :disabled="editFormVisible"></el-input>
                    </el-form-item>
                    <el-form-item label="Email" prop="mail">
                        <el-input v-model="userInfo.mail" auto-complete="off" :disabled="editFormVisible"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item align="center" v-show="editFormVisible">
                        <el-button type="success" @click="editFormVisible=false" :loading="editInfoLoading"><!--<i class="fa fa-save"></i>--> 修改数据</el-button>
                    </el-form-item>
                        <el-form-item align="center" v-show="!editFormVisible">
                            <el-button @click.native="handleCancel">取消</el-button>
                            <el-button type="success" @click="handleUpdateInfo" :loading="editInfoLoading"><i class="fa fa-save"></i> 保存数据</el-button>
                        </el-form-item>
                </el-form>
                </div>
            </el-tab-pane>
                ...
                <div @keyup.13="handleUpdatePwd">
                    <el-form :model="settingInfo" label-width="100px" :rules="pwdFormRules" ref="settingInfo">
                        ...
                        <el-form-item align="center">
                            <el-button type="success" @click="handleUpdatePwd" :loading="editPwdLoading"><i class="fa fa-save"></i> 保存数据</el-button>
                        </el-form-item>
                    </el-form>
                </div>
            </el-tab-pane>
...
<script>
    import {getUserInfo,editUserPassword,editUserInfo} from '../../api/api'
            ...
            handleUpdatePwd(){
                ...
                this.$refs.settingInfo.validate((valid) => {
                    if (valid) {
                        ...
                        editUserPassword(para,oldpwd).then((res) => {
