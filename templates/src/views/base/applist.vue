    ...
    <section>
        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
            <el-form :inline="true" :model="filters">
                <el-form-item>
                    <el-input v-model="filters.key" placeholder="应用名称、应用编码"></el-input>
                </el-form-item>
                <el-form-item>
...
<script>
    ...
    import { getAppList,addAppInfo,editAppInfo,deleteAppInfo } from '../../api/api';
    ...
    export default {
        data() {
            return {
                ...
                pageInfo:{pageIndex:1,pageSize:2,count:0},
                appList: [],
                listLoading: false,
                sels: [],//列表选中列
